...
$config["destination_folder"]			= 'D:/Websites/ajax-image-upload/uploads/'; //upload directory ends with / (slash)
$config["thumbnail_destination_folder"]	= 'D:/Websites/ajax-image-upload/uploads/'; //upload directory ends with / (slash)
$config["upload_url"] 					= "http://localhost/ajax-image-upload/uploads/"; 
